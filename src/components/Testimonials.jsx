    ...
    <div className="my-10 text-center">
      ...
      <div className="flex flex-col md:flex-row md:justify-evenly items-center">
        {testimonials.map((client, index) => (
          <div key={index} className="cards rounded-lg w-[90%] md:w-1/4 bg-gray-100 p-4 my-6 transition duration-500 ease-in-out transform hover:scale-105 hover:bg-primary">
